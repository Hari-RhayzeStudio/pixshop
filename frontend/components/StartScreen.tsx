...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect }) => {
  ...
  return (
    <div 
      className={`w-full max-w-5xl mx-auto text-center p-8 transition-all duration-300 rounded-2xl border-2 ${
        isDraggingOver 
          ? 'bg-[#722E85]/10 border-dashed border-[#D6B890]' 
          : 'border-transparent'
      }`}
      ...
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <div className="mt-6 flex flex-col items-center gap-4">
            <label 
                ...
                className="relative inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-[#722E85] bg-[#D6B890] rounded-full cursor-pointer group hover:bg-[#c4a980] transition-all shadow-[0_0_15px_rgba(214,184,144,0.5)] hover:shadow-[0_0_25px_rgba(114,46,133,0.4)]"
            >
                <UploadIcon className="w-6 h-6 mr-3 transition-transform duration-500 ease-in-out group-hover:rotate-[360deg] group-hover:scale-110 text-[#722E85]" />
                Upload Images
            </label>
